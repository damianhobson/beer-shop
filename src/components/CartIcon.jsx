...
function CartIcon() {
  ...
  return (
    ...
    >
      <img src={cartSVG} />
      <svg width="30" height="30" viewBox="0 -0.5 20 20">
        <g transform="translate(1, 0)">
          <text fill="#000" stroke="#000">10</text>
        </g>
      </svg>
